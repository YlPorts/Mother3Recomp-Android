...
DECOMP_NAME="pokeemerald"
DECOMP_URL="https://github.com/pret/pokeemerald"
# make target | elf | rom | variant dir | program id | expected rom sha1
TARGETS=(
  "rom|pokeemerald.elf|pokeemerald.gba|emerald|BPEE|f3ae088181bf583e55daf962a92bb46f4f1d07b7"
)
PROGRAM_NAME_emerald="Pokemon Emerald Version (USA)"
